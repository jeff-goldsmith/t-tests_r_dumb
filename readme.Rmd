...
Maybe you think someone taught you the formula for pooling variances when you have unequal sample sizes for a reason. Maybe you're thrilled that you remember the difference between the usual test and Welch's test. Maybe you think you're gonna need to know how an ANOVA table works someday. t.test(extra ~ group, data = sleep)
